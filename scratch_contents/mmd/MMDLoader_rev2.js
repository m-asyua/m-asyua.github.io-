...
console.log("MMDLoader_rev2:",fullPath,  this.resourcePath , filePath);
			...
			setTimeout(function (){
				...
				function _text_display(my_message, t){
					...
					if(div_tmp==null){
						...
						if(typeof message_id === "undefined" ){message_id =document.getElementsByClassName("stage_stage-bottom-wrapper_vRJed")[0];  } 
						if(message_id==null){message_id =document.getElementsByClassName("stage_stage-bottom-wrapper_vRJed")[0];  } 
						message_id.appendChild(div_tmp);
						//t.message_id.appendChild(div_tmp);
					}

					div_tmp.innerHTML  = my_message ;
					console.log("div", div_tmp, my_message);
