...
let d = document.getElementsByClassName("stage_stage-bottom-wrapper_fnczd")[0];
...
//if(offsetX>820){return;}
//if(offsetY>620){return;}
if(offsetX<0){return;}
if(offsetY<0){return;}
...
//			} );
			...
			document.addEventListener( 'wheel', onMouseWheel2, {
				passive: false
			} );
